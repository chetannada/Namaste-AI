...
export default async function Image({
  ...
  params: Promise<{ seasonSlug: string; episodeSlug: string; pageSlug: string }>;
}) {
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          {`Season ${season.seasonNumber} — EP ${epNum}`}
        </div>
        <div
          style={{
            display: "flex",
        ...
        >
          {`Page ${page.pageNumber} of ${episode.pages.length} · Handwritten Notes`}
        </div>
        <div
          style={{
            display: "flex",
